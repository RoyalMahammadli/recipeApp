export const foodInfo = [
  {
    ...
    diet: "vegetarian",
    img: "../src/assets/img/Chorizzo.webp",
    alt: "Chorizo & mozzarella gnocchi bake picture",
    includeIngredients:
      " 1 tbsp olive oil,1 onion, finely chopped,2 garlic cloves, crushed 120g chorizo, diced 2 x 400g cans chopped tomatoes,1 tsp caster sugar,600g fresh gnocchi,125 mozzarella ball, cut into chunkssmall bunch of basil, torngreen salad, to serve",
  ...
  {
    id: 2,
    foodName: "Easy chocolate fudge cake",
    img: "../src/assets/img/chocolate-fudge.webp",
    alt: "Easy chocolate fudge cake picture",
    includeIngredients:
  ...
  {
    id: 3,
    foodName: "Chilli green salad",
    img: "../src/assets/img/chilligreensalat.webp",
    alt: "Chilli green salad picture",
    includeIngredients:
      " 1 tbsp sweet chilli sauce, 1 tsp soy sauce, zest and 1tsp juice of 1 lime ,  145g bag of spinach watercress and rocket salad",
  ...
  {
    id: 4,
    foodName: "Mustardy salmon with beetroot & lentils",
    img: "../src/assets/img/mustardy.webp",
    alt: "Mustardy salmon with beetroot & lentils picture",
    includeIngredients:
      " 2 tbsp olive oil  ,1 tbsp wholegrain mustard , ½ tsp honey , 2 salmon fillets  , 250g pouch ready-cooked puy lentils  , 250g pack ready-cooked beetroot, cut into wedges  ,2 tbsp crème fraîche  ,1 small pack dill, roughly chopped , 1-2 tbsp capers  , ½ lemon, zested and cut into 2 wedges to serve , 2 tbsp pumpkin seeds, toasted  , rocket, to serve (optional) ",
    instructionsRequired: false,
    serving: 3,
    maxReadyTime: 20,
    ranking: 4,
  ...
  {
    id: 5,
    foodName: "Cheat’s cheesy focaccia",
    img: "../src/assets/img/cheats.webp",
    alt: "Cheat’s cheesy focaccia picture",
    includeIngredients:
      " 500g pack bread mix 2 tbsp olive oil, plus a little extra for drizzling 25g parmesan (or vegetarian alternative), grated  75g dolcelatte cheese (or vegetarian alternative)",
    instructionsRequired: true,
    serving: 2,
    maxReadyTime: 40,
    ranking: 4,
  ...
  },
  {
    id: 6,
    foodName: "Focaccia",
    img: "../src/assets/img/Focaccia.webp",
    alt: "Focaccia picture",
    includeIngredients:
      " 500g strong bread flour, plus extra for dusting ,7g dried fast action yeast , 2 tsp fine sea salt , 5 tbsp olive oil, plus extra for the tin and to serve , 1 tsp flaky sea salt  , ¼ small bunch of rosemary, sprigs picked",
    instructionsRequired: false,
    serving: 4,
    maxReadyTime: 45,
    ranking: 5,
